...
export const MobileNavbar = () => {
    ...
    const navItems = [
        { name: "Dash", icon: "dashboard", href: "/admin", activeColor: "text-blue-500" },
        { name: "Caisse", icon: "account_balance_wallet", href: "/admin/caisse", badge: pendingOrders, activeColor: "text-[#ec5b13]" },
        { name: "Validation", icon: "sync_alt", href: "/admin/traitement", activeColor: "text-emerald-500" },
        { name: "Stock", icon: "inventory_2", href: "/admin/catalogue", activeColor: "text-amber-500" },
        { name: "Menu", icon: "menu", href: "/admin/settings", activeColor: "text-purple-500" },
    ];
