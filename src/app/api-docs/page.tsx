...
export const metadata: Metadata = {
    ...
    other: {
        "stoplight-styles": "https://unpkg.com/@stoplight/elements@8/styles.min.css",
    },
};
 ...
 *
 * Note : le layout racine (src/app/layout.tsx) fournit déjà <html>/<head>/<body>.
 * On utilise un fragment + <link rel=stylesheet> dans le body (autorisé par
 * les navigateurs modernes) + Script component de Next pour le custom element.
 */
export default function ApiDocsPage() {
    return (
        <>
            {/* Stoplight CSS injecté en body — autorisé en HTML5, Next ne s'en plaint pas */}
            <link
                rel="stylesheet"
            ...
            <div data-testid="api-docs-container">
                ...
                />
                {/* @ts-expect-error — custom element du CDN Stoplight */}
                <elements-api
