...
import {
    getResellerNetflixOffersAction,
    type StreamingOffer,
} from "../streaming-actions";
import PurchaseSuccessModal from "../components/PurchaseSuccessModal";

export default function ResellerNetflixPage() {
    ...
    return (
        <div className="space-y-6 animate-in fade-in duration-300">
                ...
                <div className="space-y-5 min-w-0">
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-slate-400">
                            Profil partagé livré instantanément — lien magique &amp; code en
                            temps réel pour votre client.
                        </p>
                    </div>
                    ...
                    {isLoading ? (
                        ...
                        <p className="text-center text-slate-500 italic py-12">
                            Aucune offre Netflix disponible pour le moment.
                        </p>
                    ) : (
                        <ul className="space-y-2" data-testid="netflix-offers">
                            {offers.map((o) => {
                    ...
                    {!selected ? (
                        ...
                        <div className="bg-[#161616] border border-[#262626] rounded-2xl p-5 space-y-4">
                            ...
                            <Button
                                ...
                                data-testid="netflix-purchase-btn"
            ...
            <PurchaseSuccessModal
                ...
                productLabel="Netflix — Profil partagé"
