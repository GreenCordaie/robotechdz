    ...
    return (
        <main className="flex flex-1 min-w-0 overflow-hidden h-[calc(100vh-64px)] mx-[-32px] my-[-32px] bg-background-light dark:bg-background-dark font-sans antialiased">
                        ...
                        <div className="flex h-[calc(100vh-140px)] gap-4 p-4">
                            ...
                            <section className="flex-[0.4] flex flex-col bg-white dark:bg-[#110b08]/80 backdrop-blur-md">
                                {currentOrder ? (
                                    ...
                                    <div className="flex-1 flex flex-col items-center justify-center p-12 text-center text-slate-400 font-bold uppercase tracking-widest gap-4 opacity-50">
                                        <span className="material-symbols-outlined !text-6xl">receipt_long</span>
                                        <p className="text-xs">Sélectionnez une commande</p>
                                    </div>
                                )}
                            </section>
                        </div>
            ...
            <OrderDetailModal
                ...
                onReplaceCode={async (orderItemId: number, codeId: number, type: 'standard' | 'slot', reason: string) => {
                ...
                onRefundItem={async (orderItemId: number, returnToStock: boolean) => {
