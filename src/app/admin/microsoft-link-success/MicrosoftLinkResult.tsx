...
export default function MicrosoftLinkResult() {
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-10 max-w-md w-full text-center shadow-2xl">
                {isSuccess ? (
                    <>
                        ...
                        <h1 className="text-2xl font-bold text-white mb-2">Compte lié avec succès</h1>
                        <p className="text-gray-400 mb-1">Le compte Microsoft a été connecté.</p>
                        {id && (
